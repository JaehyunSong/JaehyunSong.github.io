...
df |> 
    ...
    mutate(File = if_else(!is.na(File), paste0("abstract/", Year, "/", File, ".pdf"), NA)) |> 
    select(-Type, -ID) |> 
...
df |> 
    ...
    arrange(desc(Year), ID) |> 
    mutate(File = if_else(!is.na(File), paste0("slide/", Year, "/", File, ".pdf"), NA)) |> 
    select(-Type, -ID) |> 
    mutate(Year = str_c(Year, "年度")) |> 
    group_by(Year) |> 
    gt() |> 
...
[a](_slide/2025/inuzuka_obana_hayami.pdf)